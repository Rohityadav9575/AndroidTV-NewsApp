...
android {
    namespace = "com.example.newsheadlinestv"
    compileSdk = 35

    defaultConfig {
        applicationId = "com.example.newsheadlinestv"
        minSdk = 21
        targetSdk = 35
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    implementation (libs.compose.foundation)  // For LazyColumn and related components
